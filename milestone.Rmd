...
```{r}
corpus <- Corpus(VectorSource(sample_noProfanity))
...
corpus.tdm.n2 <- TermDocumentMatrix(corpus, control = list(tokenize = n2-gram))
corpus.tdm.n3 <- TermDocumentMatrix(corpus, control = list(tokenize = n2-gram)))
